...
import { ConnectButton, useCurrentAccount, useSignPersonalMessage,useConnectWallet } from "@mysten/dapp-kit";
...
export default function Home() {
  ...
  const walletAccount  = useCurrentAccount()?.address;
  ...
  //   gameInfo,
  //   winner,
  // } = useGame(creator, joiner, walletAccount);
  ...
  const isCreator = walletAccount === creator;
  ...
  //   );
  // }
  // if (creator !== walletAccount && joiner !== walletAccount) {
  //   return (
  //     <div className=" flex flex-col gap-10  h-screen items-center justify-center  text-2xl font-medium bg-slate-900 ">
